          ...
          <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
            ...
            >
              <div className={`flex items-center justify-between ${styles.modalHeader}`}>
                <h2 className={styles.modalTitle}>피드백 보내기</h2>
                <motion.button
                  onClick={onClose}
              ...
              <form onSubmit={handleSubmit} className={styles.modalForm}>
                <div className="mb-6">
                  <label className={styles.typeLabel}>피드백 타입을 선택해주세요</label>
                  <div className={styles.typeGrid}>
                    {FEEDBACK_TYPES.map((option) => (
                      <motion.button
                        ...
                        style={{
                          borderColor:
                            selectedType === option.type ? option.color : 'rgba(0, 0, 0, 0.1)',
                          backgroundColor:
                            selectedType === option.type ? `${option.color}15` : 'white',
                        }}
                      ...
                      >
                        ...
                        <div className={styles.typeText}>{option.label}</div>
                      </motion.button>
                    ))}
                  </div>
                </div>
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    style={{
                      borderColor:
                        content.length >= 10 ? 'var(--primary-blue)' : 'rgba(0, 0, 0, 0.1)',
                    }}
                    required
                  />
                ...
                <div className={styles.buttonGroup}>
                  ...
                  <motion.button
                    ...
                    style={{
                      ...
                      cursor:
                        isSubmitting || showSuccess || content.length < 10 || content.length > 1000
                          ? 'not-allowed'
                          : 'pointer',
                    }}
                    disabled={
