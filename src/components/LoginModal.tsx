        ...
        <AnimatePresence>
            {isOpen && (
                ...
                <motion.button
                    ...
                    disabled={isLoading}
                    className="w-full py-[15px] px-[20px] mb-[15px] rounded-[50px] border border-[#E0E0E9] bg-white flex items-center justify-center gap-[12px] text-[18px] font-medium text-[#1D1C2B] cursor-pointer disabled:opacity-50"
