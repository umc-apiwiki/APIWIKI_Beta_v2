  ...
  return (
    ...
    >
      ...
      <div
        className={
          isMobile
            ? 'px-4 pt-4 pb-20 relative z-10'
            : 'grid-container pt-28 md:pt-36 pb-32 md:pb-60 relative z-10'
        }
      >
        {/* 헤더 영역 - 제목과 글쓰기 버튼 */}
        <motion.div
          className={
            isMobile
              ? 'w-full flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 md:mb-8'
              : 'col-12 flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 md:mb-8'
          }
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
                      ...
                      >
                        <div className="flex items-center gap-3 md:gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3
                              className="text-base md:text-lg font-semibold mb-1 group-hover:text-sky-600 transition-colors truncate"
                              style={{ color: 'var(--text-dark)' }}
                            >
                              {board.title}
                            </h3>
                    ...
                    {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
                      <motion.button
                        ...
                        style={{
                          ...
                          boxShadow:
                            p === page ? 'var(--shadow-blue)' : '0 2px 8px rgba(0, 0, 0, 0.1)',
                        }}
