...
export default function ActivityHistoryPage() {
  ...
  return (
    <div
      className={`min-h-screen ${styles.historyPage}`}
      ...
      <div className="max-w-5xl mx-auto px-4 pt-32 pb-20 relative z-10">
        ...
        <div className="animate-fadeInUp">
          ...
          <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm overflow-hidden">
            {activities.length === 0 ? (
              <div className="p-20 text-center text-gray-400">포인트 획득 내역이 없습니다.</div>
            ) : (
              <div className="divide-y divide-gray-50">
                {activities.map((activity) => (
                  <div
                    key={activity.id}
                    className="p-5 flex items-center justify-between hover:bg-gray-50 transition-colors select-none"
                  >
