          ...
          <div className="grid grid-cols-12 grid-gap-24 col-12">
            ...
            >
              ...
              >
                ...
                <h3 className="text-[24px] font-bold mb-4" style={{ color: 'var(--text-dark)' }}>발견</h3>
            ...
            >
              ...
              >
                ...
                <h3 className="text-[24px] font-bold mb-4" style={{ color: 'var(--text-dark)' }}>비교</h3>
                <p className="text-[16px] leading-relaxed" style={{ color: 'var(--text-gray)' }}>
            ...
            >
              ...
              >
                ...
                <h3 className="text-[24px] font-bold mb-4" style={{ color: 'var(--text-dark)' }}>공유</h3>
                <p className="text-[16px] leading-relaxed" style={{ color: 'var(--text-gray)' }}>
          ...
          <div className="col-12 space-y-8">
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-[28px] font-bold" style={{ color: 'var(--primary-blue)' }}>투명성</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-[28px] font-bold" style={{ color: 'var(--primary-blue)' }}>커뮤니티</h3>
              </div>
              <p className="text-[18px] leading-relaxed" style={{ color: 'var(--text-gray)' }}>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-[28px] font-bold" style={{ color: 'var(--primary-blue)' }}>혁신</h3>
              </div>
              <p className="text-[18px] leading-relaxed" style={{ color: 'var(--text-gray)' }}>
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  <div className="text-[18px]" style={{ color: 'var(--text-gray)' }}>{stat.label}</div>
                </motion.div>
              </motion.div>
            ))}
          </div>
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  background: 'linear-gradient(45deg, var(--primary-blue), transparent, var(--primary-blue))',
                }}
                animate={{
                  x: ['-100%', '100%'],
                }}
              ...
              >
                ...
                >
                  <Link
                    ...
                    style={{ color: 'var(--primary-blue)', borderColor: 'var(--primary-blue)', borderRadius: '50px' }}
                  >
                    홈으로 돌아가기
                  </Link>
                </motion.div>
